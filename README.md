...
3. Adicione o remote upstream para manter seu repositório local atualizado: `git remote add upstream https://github.com/elidianaandrade/dio-lab-open-source.git`;
    ...
    > Utilize o comando 'git remote -v' para listar o repositório remote configurado no momento para sua bifurcação. Veja mais em: [Configurar um repositório remoto para um fork](https://docs.github.com/pt/pull-requests/collaborating-with-pull-requests/working-with-forks/configuring-a-remote-repository-for-a-fork).
...
4. c* and name it as `feat/community/seunomedeusuario`: `git checkout -b feat/community/yourusername`;
